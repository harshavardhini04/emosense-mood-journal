...
Recommend 6 movies that match this mood and primarily belong to this cinema language: ${language}.
Movie titles must be in English, even if the original language is not English.
Return only a JSON array like:
[ { "title": "Movie Name", "year": 2024 } ]
No descriptions, no poster URLs, no markdown, no extra keys.`;
